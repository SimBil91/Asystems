...
class moving(smach.State):
    def __init__(self):
        smach.State.__init__(self, outcomes=['to_start','reset','to_arrow_keys','to_predefined_position','to_kinect_navigation'])
...
class arrow_keys(smach.State):
    def __init__(self):
        smach.State.__init__(self, outcomes=['to_moving','reset'])
...
def main():
	...
	smach.StateMachine.add('arrow_keys', arrow_keys(), 
                               transitions={'to_moving':'moving',
					    'reset':'arrow_keys'})

	smach.StateMachine.add('predefined_position', predefined_position(), 
                               transitions={'to_moving':'moving',
					    'reset':'predefined_position'})


	smach.StateMachine.add('kinect_navigation', kinect_navigation(), 
                               transitions={'to_moving':'moving',
					    'reset':'kinect_navigation'})
